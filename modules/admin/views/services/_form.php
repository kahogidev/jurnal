...
$js1 = <<<JS
    CKEDITOR.replace( 'services-body_uz' );
    CKEDITOR.replace( 'services-body_ru' );
    CKEDITOR.replace( 'services-body_en' );
JS;
$this->registerJs($js1);
$js2 = <<<JS
    ...
    <div class="card-body p-4 border rounded">
        <div class="row">
            ...
            <div class="col-6">
                ...
                <div class="box">
                    <div class="js--image-preview " style="background-image: url(<?=StaticFunctions::getImage('services',$model->id,$model->image)?>)"></div>
