...
<!--        <button><a href="https://payme.uz/fallback/merchant/?id=62a0a872aa40a686d47cf910" class="btn" target="_blank">online to'lov qilish <i class="fas fa-angle-right"></i></a></button>-->
        <button><a href="https://payme.uz/fallback/merchant/?id=649547ff5b17f8b641a8d8e0" class="btn" target="_blank">online to'lov qilish <i class="fas fa-angle-right"></i></a></button>
    </div>
</section>